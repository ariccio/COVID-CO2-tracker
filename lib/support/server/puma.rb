# https://github.com/testdouble/cypress-rails/blob/402af0e2424b68983216e542e2cc1e9b960f9a7e/lib/cypress-rails/server/puma.rb
# puma too?!
    ...
    class Server
      module Puma
        def self.create(app, port, host)
          ...
          default_options = {Host: host, Port: port, Threads: "0:2", workers: 0, daemon: false}
          ...
          logger.log "Puma * Version #{::Puma::Const::PUMA_VERSION} , codename: #{::Puma::Const::CODE_NAME}"
          logger.log "Puma * Min threads: #{conf.options[:min_threads]}, max threads: #{conf.options[:max_threads]}"
